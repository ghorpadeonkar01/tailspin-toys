...
The repository's coding standards are maintained in the [Copilot instructions](.github/copilot-instructions.md) and the technology-specific [instruction files](.github/instructions/). In particular:
...
- ESLint enforces the shared TypeScript formatting conventions, including single quotes, semicolons, multiline trailing commas, and consistent brace spacing.
