...
- Explain why a component or interaction works the way it does, especially for accessibility and keyboard behavior.
- Do not use comments to restate markup, Tailwind classes, or obvious control flow.
